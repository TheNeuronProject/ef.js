...
var resolvePath = function resolvePath(arr, obj) {
	for (var i = 0; i < arr.length - 1; i++) {
		var name = arr[i];
		if (!obj[name]) _Object$defineProperty(obj, name, { value: {} });
		obj = obj[name];
	}
	return obj;
};
...
var create$2 = function create$2(_ref) {
	...
	var _loop = function _loop(i) {
		...
		function _set2(value) {
			...
			var oldValType = Object.prototype.toString.call(children[node.name]);
			var newValType = Object.prototype.toString.call(value);
			...
			if (children[node.name]) {
				if (oldValType === '[object Array]') {
					...
					try {
						for (var _iterator2 = _getIterator(children[node.name]), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
							var j = _step2.value;
							parent.removeChild(j.$element);
						}
					} catch (err) {
						_didIteratorError2 = true;
						_iteratorError2 = err;
			...
			if (newValType === '[object Array]') {
				...
				try {
					for (var _iterator3 = _getIterator(value), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
						var _j = _step3.value;
						fragment.appendChild(_j.$element);
					}
				} catch (err) {
					_didIteratorError3 = true;
					_iteratorError3 = err;
